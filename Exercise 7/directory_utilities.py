...
if __name__ == '__main__':
    print(f"This script provides information about the operating system and current working directory.")
...
# Check the OS in use, lower case
 ...
 # Get the current working directory
    ...
    print(f"You are currently in: {current_working_directory}")
